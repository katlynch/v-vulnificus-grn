...
[t,v] = ode23tb(@(t,v)vvsys(t,v,a,b,n,p,k,km,var_Fe,var_RBC,var_temp),t0:0.01:tfinal,v0,Opt);
...
% figure()
% hold on
% plot(v(:,13),v(:,14),'linewidth',2)    % Pa
% %xlim([0,1])
% %ylim([0,1])
% % plot(0:0.1:1,0:-0.1:0)
% hold off
...
% debugging check
    % v = [1a 2d 3f 4i 5is 6r 7rs 8vi 9ve 10he 11hi 12fe 13Pa 14Pr 15Pd 16Pi 17Pv 18Pvi 19Pvf]
    value = v(14);   % Want to know if value crosses 0
    pa = v(13)
    pr = v(14)
    p0 = 1-pa-pr
...
% v = [1a 2d 3f 4i 5is 6r 7rs 8vi 9ve 10he 11hi 12fe 13Pa 14Pr 15Pd 16Pi 17Pv 18Pvi 19Pvf]
dpa = km(1)*v(14)*v(7) - k(1)*v(13) + (1/100)*v(14);
dpr = k(1)*v(13) - km(1)*v(14)*v(7) + km(2)*(1-v(13)-v(14)) - k(2)*v(14)*(1-v(3)) - (1/100)*v(14);
